	...
	<body> 
	    ...
	    <form action="UserServlet" method="get">
	        <table width="777" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="word-break:break-all">
	           ...
	           if(userList==null){
	           response.sendRedirect("UserServlet?operate=queryAdmin");
	           }else{
	           %>
	           ...
	           <td width="597" align="left" valign="top" bgcolor="#FFFFFW">
						...
						<table border="0" width="94%" rules="none"  style="margin-top:8px">
                            ...
                            <tr>
								...
								<td><a href="<%=pathx %>/UserServlet?operate=frontupdateAdmin&id=<%=userAdmin.getId()%>">修改</a></td>
                                <td><a href="UserServlet?id=<%=userAdmin.getId()%>&operate=deleteAdmin">删除</a></td>
							</tr>	
							<%}
							} %>
							<tr><td><input type="submit" value="批量删除"/>
							<input type="hidden" value="deleteAdminAll" name="operate"/></td></tr>
							<tr>
								<td colspan="10">
									&nbsp;
								</td>
