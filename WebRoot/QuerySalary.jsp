	...
	<body> 
	    <center>
	        <table width="777" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="word-break:break-all">
	           ...
	           if(salaryList==null){
	           response.sendRedirect("SalaryServlet?operate=query");
	           }else{
	           %>
	           ...
	           <td width="597" align="left" valign="top" bgcolor="#FFFFFW">
						...
						<table border="0" width="94%" rules="none"  style="margin-top:8px">
							...
							<tr><td colspan="6" align="right">
									<a href="#">首页</a>
									<a href="<%=pathx %>/SalaryServlet?operate=query&pageN=<%=pageN-1 %>">上一页</a>
									<a href="<%=pathx %>/SalaryServlet?operate=query&pageN=<%=pageN+1 %>">下一页</a>
									<a href="#">尾页</a>
								</td>
